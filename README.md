...
В списке моделей Cursor выбирай варианты с пометкой `[Vibemode]`, например
`GPT-5.5 [Vibemode]`. Одноименные варианты без этой пометки могут быть родными
моделями Cursor и зависеть от тарифа Cursor.
...
Cursor. Внутри Cursor эти модели помечаются как `[Vibemode]`, чтобы не
смешиваться с одноименными моделями самого Cursor. Вручную можно выбрать режим:
